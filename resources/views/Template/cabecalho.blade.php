<div class="topo d-flex justify-content-space-between">
	...
	<a href="index.php?link=1" class="logo"><img src="{{url('assets/painel/img/logo-laravel.png')}}" class="d-inline-block" width="170"></a>

	<ul class="menu-topo">
		<li><a href="#" class="text-uppercase"><i class="fas fa-lock"></i> Login</a></li>
		<li>
			<img src="{{url('assets/painel/img/foto01.png')}}" class="img-user">
